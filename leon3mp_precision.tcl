...
add_input_file -format VHDL -work work ahbtranschecker.vhd
add_input_file -format VHDL -work work uartTX.vhd
add_input_file -format VHDL -work work srl_buffer_32.vhd
add_input_file -format VHDL -work work timestamps.vhd
