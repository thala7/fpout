...
analyze -f VHDL -library work ahbtranschecker.vhd
analyze -f VHDL -library work uartTX.vhd
analyze -f VHDL -library work srl_buffer_32.vhd
analyze -f VHDL -library work timestamps.vhd
